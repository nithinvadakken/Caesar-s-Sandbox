...
var parseEraPatterns = {
  any: [/^ac/i, /^dc/i],
  wide: [/^(abans de crist|abans de la era com[uú])/i, /^(despr[eé]s de crist|era com[uú])/i]
};
...
var parseMonthPatterns = {
  narrow: [/^g/i, /^f/i, /^m/i, /^a/i, /^m/i, /^j/i, /^j/i, /^a/i, /^s/i, /^o/i, /^n/i, /^d/i],
  any: [/^gen/i, /^febr/i, /^març/i, /^abr/i, /^maig/i, /^juny/i, /^jul/i, /^ag/i, /^set/i, /^oct/i, /^nov/i, /^des/i]
};
