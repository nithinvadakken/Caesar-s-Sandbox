...
var _index7 = _interopRequireDefault(require("./_lib/parsers/index.js"));

var _index8 = _interopRequireDefault(require("../_lib/format/longFormatters/index.js"));
...
function parse(dirtyDateString, dirtyFormatString, dirtyBaseDate, dirtyOptions) {
  ...
  for (i = 0; i < tokens.length; i++) {
    ...
    if (!options.useAdditionalWeekYearTokens && (0, _index9.isProtectedWeekYearToken)(token)) {
      (0, _index9.throwProtectedError)(token);
    }

    if (!options.useAdditionalDayOfYearTokens && (0, _index9.isProtectedDayOfYearToken)(token)) {
      (0, _index9.throwProtectedError)(token);
    }
